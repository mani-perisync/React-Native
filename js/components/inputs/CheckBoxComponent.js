...
export const CheckBoxComponent = ({ style,borderColor,borderWidth, size, onPress, check }) => {
    ...
    return(
        ...
        // </TouchableOpacity>
        // new
        <TouchableOpacity onPress={onPress} style={[ padding(4), radius(6), {borderWidth: borderWidth,borderColor:borderColor,width: size, height: size}, styles.selfStart, styles.allCenter, style ]}>
            <IconComponent size={size ? size : 30} name={check ? "check" : ""}/>
